...
# (sem latexmk, sem biber/biblatex, sem abnTeX2). Formatação ABNT aplicada
# manualmente sobre a classe memoir; citações numéricas (unsrt).
#
...
if [ "${1:-}" = "clean" ]; then
    rm -f main.aux main.bbl main.blg main.log main.out main.toc main.lof main.lot main.loq main.synctex.gz
