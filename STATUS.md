...
- **POC 2 — Laboratório funcional (2026-09-10):** sala modelada no Blender 5.2.1 e exportada como GLB (`assets/lab404/lab_sala_poc2.glb`, 245 objetos, 33 materiais, 35 malhas `-col`), interação desacoplada, inventário diegético, porta com trava, estados de equipamento serializáveis e missão `RESTAURAR_COMUNICACAO`.
